                ...
                <form onSubmit={handleSubmit(handleSubmitForm)}>
                    ...
                    <div className="form-group">
                        ...
                        <div className="form-control-wrap">
                            <input
                                className={`form-control form-control-lg ${errors.first_name && "error"}`}
                                type="text"
                                id="name_surname"
                                {...register("first_name", {required: 'Ismi yoki familiyani kiriting'})}
                            />
                            {errors.first_name && (
                    ...
                    <div className="form-group">
                        ...
                        <div className="form-control-wrap">
                            <InputMask
                                ...
                                className={`form-control-lg form-control  ${errors.first_name && "error"}`}
                                mask="(99) 999-99-99"
